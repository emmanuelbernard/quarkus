...
public class PanacheRxQueryImpl<Entity> implements PanacheRxQuery<Entity> {
    ...
    PanacheRxQueryImpl(EntityManager em, javax.persistence.Query jpaQuery, String query, Object paramsArrayOrMap) {
        this.em = em;
    ...
    public long count() {
        if (count == null) {
            ...
            if (paramsArrayOrMap instanceof Map)
                RxOperations.bindParameters(countQuery, (Map<String, Object>) paramsArrayOrMap);
            else
                RxOperations.bindParameters(countQuery, (Object[]) paramsArrayOrMap);
