...
public class JandexUtil {
    static final DotName DOTNAME_GENERATE_BRIDGE = DotName.createSimple(GenerateBridge.class.getName());

    static String getSignature(MethodInfo method, Function<String, String> typeArgMapper) {
    ...
    static String getDescriptor(MethodInfo method, Function<String, String> typeArgMapper) {
        List<Type> parameters = method.parameters();
